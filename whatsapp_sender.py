...
Bruno_WHATSAPP_INSTANCE_ID = os.getenv("Bruno_WHATSAPP_INSTANCE_ID")

if not Bruno_WHATSAPP_API_KEY or not Bruno_WHATSAPP_INSTANCE_ID:
...
ENDPOINT = f"{API_BASE_URL}/message/sendMedia/{Bruno_WHATSAPP_INSTANCE_ID}"
...
def enviar_texto_whatsapp(numero_whatsapp, texto):
    endpoint = f"{API_BASE_URL}/message/sendText/{Bruno_WHATSAPP_INSTANCE_ID}"
    payload = {"number": numero_whatsapp, "text": texto}
    headers = {
        "apikey": Bruno_WHATSAPP_API_KEY,
        "Content-Type": "application/json"
    }
